...
- [`Russell`] - A collection of tools that assist in the development of scientific computations (and by extension audio DSP). It includes numerical methods and solvers for differential equations and other linear algebra tools. It is written in the [`Rust`] programming lanugage. 
