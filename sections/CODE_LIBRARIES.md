...
- [Firewheel DSP](https://github.com/BillyDM/Firewheel/tree/main/crates/firewheel-core/src/dsp) - A small collection of DSP I use in my Firewheel library, written in Rust.
